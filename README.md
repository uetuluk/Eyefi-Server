...
Because of that huge parts of the code, all about the xml handling and parsing, that sets up and controlls the connection with the sd card, have been copied from michaelbrandts git-repo: "https://github.com/michaelbrandt/node-eyefimobiserver" and slightly modified to work properly especial with newer versions of node.
